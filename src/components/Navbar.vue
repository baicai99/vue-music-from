      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
          <ul class="navbar-nav me-auto mt-2 mt-lg-0">
            <li class="nav-item" v-for="(label, index) in Music_type" :key="label.text">
              <a class="nav-link" href="#" :class="{ active: label.isActive }"
                @click="setActive(label); goToPage(index)">{{ label.text
                }}</a>
            </li>
          </ul>
